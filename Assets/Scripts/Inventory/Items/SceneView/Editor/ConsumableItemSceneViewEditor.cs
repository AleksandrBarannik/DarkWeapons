...
[CustomEditor(typeof(ConsumableItemSceneView))]
public class ConsumableItemSceneViewEditor : Editor
{
    private int selectedIndex;
    private List<ConsumableItem> itemList;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_itemsDataBase == null)
        {
            ...
            itemList = _itemsDataBase.ConsumableItems;
